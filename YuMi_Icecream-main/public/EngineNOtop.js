            ...
            if (list != null) {
                Object.keys(list).forEach(key => {
                    ...
                    if (key != CurrentOrder) {
                        ...
                        FlavorQ.appendChild(document.createTextNode(list[key]['Flavor'] + " Ice Cream")); //Change from Flavor 
                        //FlavorQ.setAttribute("src", "pic/Choco ice-sream.png"); //add this w line for pic    
                        //FlavorQ.setAttribute("height", "50"); //another line
...
function AddOrderChoc() {
    xhr3.open("POST", "https://yumi-icecream-default-rtdb.asia-southeast1.firebasedatabase.app/Queue.json", false);
    obj = '{ "Name": "' + document.getElementById("Name").value + '" ,"Flavor": "Chocolate"}'; //change
    xhr3.send(obj);
    ...
    xhr3.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (Pos1 != "Empty") {
                ...
                document.getElementById("Pos1Top").setAttribute("src", "pic/Choco ice-sream.png");
            ...
            if (Pos2 != "Empty") {
                ...
                document.getElementById("Pos2Flavor").setAttribute("src", "pic/Choco ice-sream.png");
                document.getElementById("Pos2Flavor").setAttribute("width", "125");
            ...
            if (Pos3 != "Empty") {
                ...
                document.getElementById("Pos3Flavor").setAttribute("src", "pic/Choco ice-sream.png");
                document.getElementById("Pos3Flavor").setAttribute("width", "125");
...
function GetPos1() {
    ...
    xhr4.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("Pos1Name").innerHTML = Pos1["Name"];
            document.getElementById("Pos1Flavor").innerHTML = Pos1["Flavor"] + " Icecream";
            document.getElementById("Pos1Flavor").setAttribute("src", "pic/Choco ice-sream.png");
            document.getElementById("Pos1Flavor").setAttribute("width", "125");
        }
    };
}
